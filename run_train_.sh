...
# Run the script:
#python -u multitask_classifier.py --use_gpu --local_files_only --option finetune --task qqp --hidden_dropout_prob 0.1
python -u multitask_classifier.py --task qqp --quora_train data/quora-paraphrase-train.csv --quora_dev data/quora-paraphrase-dev.csv --quora_test data/quora-paraphrase-test-student.csv --option finetune --epochs 10 --batch_size 32 --lr 1e-5